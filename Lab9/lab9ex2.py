...
def main():
    #generate data
    with open('C:\\Users\\tudor\\PycharmProjects\\lab1pmp\\labPMP\\Lab9\\date500.csv', 'w', newline='') as file:
     ...
     dummy_data = np.loadtxt('C:\\Users\\tudor\\PycharmProjects\\lab1pmp\\labPMP\\Lab9\\date500.csv')
     x_1 = dummy_data[:, 0]
     y_1 = dummy_data[:, 1]
